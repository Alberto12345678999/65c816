...
function activateDocumentSymbolProvider(context) {
    const provider = new DocumentSymbolProvider_1.snes65c816DocumentSymbolProvider();
    context.subscriptions.push(vscode.languages.registerDocumentSymbolProvider({ language: 'snes65c816' }, provider));
}
