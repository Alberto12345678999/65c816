...
exports.snes65c816DocumentSymbolProvider = void 0;
const vscode = __importStar(require("vscode"));
// SNES 65C816 DocumentSymbolProvider, adapted from NES 6502 version
class snes65c816DocumentSymbolProvider {
    provideDocumentSymbols(document) {
        ...
        for (let lineNumber = 0; lineNumber < lines.length; lineNumber++) {
            ...
            // Match .proc or function-like blocks (asar, xkas may use different conventions, update as needed)
            ...
            // Match standalone global label (standard SNES/asar/xkas: label:)
            ...
            // Match simple defines/constants (e.g., VAR = $7E2002)
            ...
            // Match asar/xkas/SNES assembler directives (update as needed for .base, .org, etc)
            const directiveMatch = line.match(/^[ \t]*\.(base|org|bank|incbin|include|if|endif|else|macro|endmacro|proc|endproc|db|dw|dl|define|undefine|warn|error|assert|enum|endenum|fill|pad|align|repeat|endrepeat|print|printt|printv|printhex|size|end|map|endmap|namespace|endnamespace|function|endfunction|return|struct|endstruct|table|endtable|scope|endscope|hex|dcb|dcw|dcl|dcz|byte|word|long|zero|ascii|asciiz|asc|str|text|equ|endf|proc|endp|seg|segment|ends|section|endsection)\b\s*(.*)/i);
            if (directiveMatch) {
...
exports.snes65c816DocumentSymbolProvider = snes65c816DocumentSymbolProvider;
